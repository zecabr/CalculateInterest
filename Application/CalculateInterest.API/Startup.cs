...
using CalculateInterest.Domain.Service;
...
namespace CalculateInterest.API
{
	public class Startup
	{
		...
		{
			services.AddTransient<ICalculateInterestAppService, CalculateInterestAppService>();
			services.AddTransient<ICalculateInterestDomService, CalculateInterestDomService>();
